...
def draw_tier_3():
    ...
    for y_idx in range(8):
        ...
        # Adding a missing sanankou tag to Three Concealed Pungs
        if title == 'Three Concealed Pungs':
            draw.text((two_third_width + 364, y+8), 'sanankou', fill="black", font=italic_small_font)
